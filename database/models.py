...
class Protein(models.Model):
    ...
    function_source = models.CharField(max_length=1000, null=True, blank=True)
    cog_category = models.CharField(max_length=1000, null=True, blank=True)
    ec_number = models.CharField(max_length=1000, null=True, blank=True)
    cog_id = models.CharField(max_length=1000, null=True, blank=True)
...
class AntimicrobialResistanceGene(models.Model):
    ...
    strand = models.IntegerField(default=0, choices=STRAND)
    product = models.CharField(max_length=1000, null=True, blank=True)
    cutoff = models.CharField(max_length=1000, null=True, blank=True)
    hsp_identifier = models.CharField(max_length=1000, null=True, blank=True)
    best_hit_aro = models.CharField(max_length=1000, null=True, blank=True)
...
class SignalPeptides(models.Model):
    ...
    strand = models.IntegerField(default=0, choices=STRAND)
    product = models.CharField(max_length=1000, null=True, blank=True)
    prediction = models.CharField(max_length=1000, null=True, blank=True)
    ...
    cs_position = models.CharField(max_length=1000, null=True, blank=True)
