...
class Protein(models.Model):
    ...
    plasmid_id = models.CharField(max_length=500, null=True, blank=True)
    protein_id = models.CharField(max_length=500)
    source = models.IntegerField(default=0, choices=SOURCE_TYPE)
    orf_source = models.CharField(max_length=500, null=True, blank=True)
    ...
    function_source = models.CharField(max_length=500, null=True, blank=True)
    cog_category = models.CharField(max_length=500, null=True, blank=True)
    ec_number = models.CharField(max_length=500, null=True, blank=True)
    cog_id = models.CharField(max_length=500, null=True, blank=True)
